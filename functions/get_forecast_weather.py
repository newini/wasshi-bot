...
def getForecastWeather(city_jp):
    if city_jp == "":
        ...
        return (
            "https://wasshi-bot.herokuapp.com/send_from_tmp?filename=city_not_found.jpg"
        )
    ...
    if "cod" in data and data["cod"] == "404":
        shutil.copyfile(
            "assets/images/city_not_found_owm.jpg", "tmp/city_not_found_owm.jpg"
        )
